...
VALUES (
    ...
    (
        ...
        'Adjustable height standing desk, 120x60cm',
        499.99,
        30,
        'cat-furniture',
        TRUE
    ...
    (
        ...
        'Herman Miller Aeron, size B, fully adjustable',
        1299.99,
        12,
        'cat-furniture',
        TRUE
    ...
    (
        ...
        'Cherry MX Brown switches, aluminum frame',
        149.99,
        50,
        'cat-electronics',
        TRUE
    ...
    (
        ...
        'Wireless mouse, ergonomic, 8K DPI',
        99.99,
        60,
        'cat-electronics',
        TRUE
    ...
    (
        ...
        'PRINTER-001',
        'HP LaserJet Pro',
        'Black & white laser printer, duplex, Wi-Fi',
        299.99,
        20,
        'cat-electronics',
        TRUE
    ...
    (
        ...
        'TABLET-001',
        'iPad Air 11"',
        'M2 chip, 128GB, Wi-Fi, Space Gray',
        599.99,
        35,
        'cat-electronics',
        TRUE
    ...
    (
        ...
        'HEADSET-001',
        'Sony WH-1000XM5',
        'Noise cancelling, 30h battery, Bluetooth',
        399.99,
        28,
        'cat-electronics',
        TRUE
    ...
    (
        ...
        'DOCK-001',
        'CalDigit TS4',
        'Thunderbolt 4 dock, 18 ports, 98W power delivery',
        399.99,
        18,
        'cat-electronics',
        TRUE
    ...
    (
        ...
        'CABLE-001',
        'USB-C Cable 2m',
        'Thunderbolt 4, 40Gbps, 100W charging',
        29.99,
        100,
        'cat-electronics',
        TRUE
    ...
    (
        ...
        'BACKPACK-001',
        'Laptop Backpack',
        'Water-resistant, fits 15" laptop, USB charging port',
        69.99,
        55,
        'cat-accessories',
        TRUE
    ...
    (
        ...
        'ORGANIZER-001',
        'Desktop Organizer',
        'Bamboo wood, 5 compartments, cable management',
        39.99,
        70,
        'cat-furniture',
        TRUE
    ...
    (
        ...
        'Small succulent, realistic, no maintenance',
        19.99,
        90,
        'cat-accessories',
        TRUE
    ...
    (
        ...
        'Large, ruled, hardcover, 240 pages',
        24.99,
        75,
        'cat-stationery',
        TRUE
    ...
    (
        ...
        'PEN-001',
        'Pilot G2 Gel Pens Pack',
        'Pack of 12, 0.7mm, black ink',
        14.99,
        120,
        'cat-stationery',
        TRUE
    ...
    (
        ...
        'WHITEBOARD-001',
        'Magnetic Whiteboard',
        '90x60cm, aluminum frame, includes markers',
        89.99,
        22,
        'cat-furniture',
        TRUE
